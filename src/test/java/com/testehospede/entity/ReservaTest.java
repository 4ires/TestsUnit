...
public class ReservaTest {
	...
	public void testId() {
		...
		assertEquals(2L, reserva.getId(), "O ID deve ser igual ao valor atribuído");
	}
	...
	public void testCheckInData() {
		...
		//Assert:
		assertEquals(LocalDate.of(2024, 9, 1), reserva.getCheckInData(), "A data de check-in deve ser igual ao valor atribuído");
	}
	...
	public void testCheckOutData() {
		...
		//Assert:
		assertEquals(LocalDate.of(2024, 9, 10), reserva.getCheckOutData(), "A data de check-out deve ser igual ao valor atribuído");
	}
